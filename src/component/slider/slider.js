...
import video2 from "../../video/res.mp4";
import {
  faFacebook,
  faGithub,
  faLinkedin,
...
const Slider = () => {
  return (
    <div className="video-section">
      <video src={video1} muted loop autoPlay className="visible"></video>
      <video src={video2} muted loop autoPlay className="notVisible"></video>
